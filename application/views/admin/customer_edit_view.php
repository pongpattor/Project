                        ...
                        <?php foreach ($customer as $row) : ?>
                            <div class="row justify-content-center">
                                <div class="col-sm col-md col-xl-6 ">
                                    ...
                                    <input type="text" name="customerIdCard" id="customerIdCard" class="form-control" maxlength="13" value="<?= $row->CUSTOMER_IDCARD; ?>">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm col-md col-xl-6 ">
                                    <label>ชื่อ </label>
                                    <input type="text" name="customerFirstName" id="customerFirstName" class="form-control" maxlength="20" value="<?= $row->CUSTOMER_FIRSTNAME; ?>">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm col-md col-xl-6 ">
                                    <label>นามสกุล </label>
                                    <input type="text" name="customerLastName" id="customerLastName" class="form-control " maxlength="20" value="<?= $row->CUSTOMER_LASTNAME; ?>">
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm col-md col-xl-6 ">
                                    ...
                                    <select id="customerGender" name="customerGender" class="form-control">
                                        ...
                                        <option value="2" <?php if ($row->CUSTOMER_GENDER == 1) {
                                                                echo 'selected';
                                                            } ?>>หญิง</option>
                                    </select>
                                        ...
                                        <tbody id="bodyTel">
                                            ...
                                            foreach ($customerTel as $rowTel) { ?>
                                                <tr id="row<?= $rowid; ?>">
                                                    ...
                                                    <td><input type="tel" class="form-control customerTel" name="customerTel[]" value="<?= $rowTel->CUSTOMERTEL_TEL; ?>" maxlength="10"></td>
                                                    <td>
                                                        <?php if ($rowid == 1) { ?>
                            ...
                            <div class="row justify-content-center">
                                <div class="col-sm col-md col-xl-6 ">
                                    <label>ที่อยู่</label>
                                    <textarea name="customerAddress" id="customerAddress" class="form-control" rows="5" maxlength="100"><?= $row->CUSTOMER_ADDRESS ?></textarea>
