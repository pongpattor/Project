                    ...
                    <form action="<?= site_url('admin/product/insertProduct') ?>" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-sm col-md col-xl-6" id="rowTypeProductName">
                                ...
                                <input type="number" class="form-control" name="costPrice" id="costPrice" required step="0.01" min="0">
                            </div>
                        </div>
                        <div class="row justify-content-center">
                            <div class="col-sm col-md col-xl-6" id="rowTypeProductName">
                                <label>ราคาขาย</label><br>
                                <input type="number" class="form-control" name="sellPrice" id="sellPrice" required  min="0">
                            </div>
                        </div>
                        <br>
                        <div class="row justify-content-center">
